...
import otpImage from "../assets/otp2.svg";
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-6xl bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row">
        {/* Left Section */}
        <div className="md:w-1/2 bg-[#3045e0] p-8 text-white flex flex-col justify-between">
          <Link
            to="/register"
            className="flex items-center text-blue-200 hover:text-white mb-8"
          >
